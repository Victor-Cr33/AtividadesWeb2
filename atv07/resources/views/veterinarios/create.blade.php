        ...
        <div class="row">
            <div class="col" >
                <div class="form-floating mb-3">
                    ...
                    @endif
                    <label for="crmv">CRMV do Veterinarios</label>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col" >
                <div class="form-floating mb-3">
                    ...
                    @endif
                    <label for="nome">Nome do Veterinarios</label>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col" >
                <div class="form-floating mb-3">
                    <select class="form-control  {{ $errors->has('especialidades') ? 'is-invalid' : '' }}" name="especialidades" >
